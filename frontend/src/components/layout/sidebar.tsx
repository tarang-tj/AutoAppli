...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className={cn("fixed inset-y-0 left-0 z-40 w-64 bg-zinc-950 border-r border-zinc-800 transform transition-transform duration-200 md:translate-x-0", open ? "translate-x-0" : "-translate-x-full")}>
