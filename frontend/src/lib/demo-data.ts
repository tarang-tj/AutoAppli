...
let demoJobs: Job[] = [
  ...
  },
  {
    ...
    closed_reason: "role_closed",
    closed_at: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
    created_at: new Date(Date.now() - 35 * 24 * 60 * 60 * 1000).toISOString(),
    updated_at: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
  },
  // ── Ghosted applications (close-out without a response) ─────
  {
    id: "job-11",
    company: "Lyft",
    title: "Data Analyst - Marketplace",
    url: "https://www.lyft.com/careers/data-analyst-marketplace",
    description: "Analyze rider/driver marketplace dynamics and pricing efficiency.",
    status: "applied",
    sort_order: 3,
    source: "linkedin",
    applied_at: new Date(Date.now() - 55 * 24 * 60 * 60 * 1000).toISOString(),
    notes: "No response after 50+ days. Probably ghosted.",
  ...
  },
  {
    ...
    url: "https://www.coinbase.com/careers/growth-analyst",
    description: "Drive user acquisition analytics for crypto-native product lines.",
    status: "offer",
    sort_order: 1,
    source: "company-website",
    applied_at: new Date(Date.now() - 45 * 24 * 60 * 60 * 1000).toISOString(),
    notes: "Received offer but declined — compensation didn't match expectations.",
    closed_reason: "offer_declined",
    closed_at: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString(),
    created_at: new Date(Date.now() - 50 * 24 * 60 * 60 * 1000).toISOString(),
    updated_at: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString(),
  },
  // ── Stale applications (triggers Ghost Nudge modal) ──────────
  {
    id: "job-13",
    company: "Netflix",
    title: "Senior Analytics Engineer",
    url: "https://jobs.netflix.com/careers/senior-analytics-engineer",
    description: "Build data models and tooling powering Netflix's internal analytics stack.",
    status: "applied",
    sort_order: 4,
    source: "linkedin",
    applied_at: new Date(Date.now() - 48 * 24 * 60 * 60 * 1000).toISOString(),
    notes: "Applied via LinkedIn Easy Apply. Radio silence since.",
    salary_min: 170000,
    salary_max: 230000,
  ...
  },
  {
    ...
    url: "https://www.datadoghq.com/careers/product-data-analyst",
    description: "Partner with PMs on feature adoption and retention analytics.",
    status: "interviewing",
    sort_order: 2,
    source: "indeed",
    applied_at: new Date(Date.now() - 42 * 24 * 60 * 60 * 1000).toISOString(),
    notes: "Recruiter screen complete — no follow-up scheduled.",
    salary_min: 135000,
    salary_max: 175000,
    location: "New York, NY",
    remote_type: "hybrid" as const,
